    ...
    <li>
        ...
        <div class="collapse" id="groupAdmin">
            <ul class="nav">
                ...
                <li class="admin show">
                    <a href="{{ base_url('admin/admins') }}">Danh sách Admin</a>
                </li>
                <li class="admin add">
                    <a href="{{ base_url('admin/admins/add') }}">Thêm admin</a>
                </li>
            </ul>
        </div>
    </li>
    <li>
        <a data-toggle="collapse" href="{{ base_url('admin#users') }}">
            <i class="material-icons">group</i>
            <p>Quản Lý User
                <b class="caret"></b>
            </p>
        ...
        <div class="collapse" id="users">
            <ul class="nav">                
                <li class="admin show">
                    <a href="{{ base_url('admin/users') }}">Danh sách User</a>
                </li>                
            </ul>
        </div>
    </li>
