...
@section('title', "Danh sách bình luận của phim ".$data['movie']->name)
@section('main')
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title">Danh sách bình luận của phim {{ $data['movie']->name }} </h4>
                    <div class="toolbar">                        
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="my-container" style="margin: 5px;width: 30%;display: inline-block">
                                    ...
                                    <span>theo</span>
                                        ...
                                        <option value="mov_id" {{ @$data['filter']['orderBy'] == 'mov_id' ? 'selected' : ''}}>ID Phim</option>
                                        <option value="user_id" {{ @$data['filter']['orderBy'] == 'user_id' ? 'selected' : ''}}>ID User</option>
                        ...
                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">                                        
                                        @if (session()->get('permission')->canUpdate && $value->status != 1)
                                            <a href="{{ route('Admin.CommentController.recover',['mov_id' => $value->mov_id , 'id' => $value->id]) }}" class="btn btn-simple btn-danger btn-icon remove">Khôi phục</a>
                                        @elseif(session()->get('permission')->canUpdate)
                                            <a href="{{ route('Admin.CommentController._delete',['mov_id' => $value->mov_id , 'id' => $value->id]) }}" class="btn btn-simple btn-danger btn-icon remove">Xóa</a>
                                            <a href="{{ route('Admin.UserController.lockcomment',['mov_id' => $value->mov_id , 'id' => $value->user_id]) }}" class="btn btn-simple btn-danger btn-icon remove">Khóa bình luận</a>
                                        @endif
