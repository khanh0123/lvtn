                        ...
                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $value->id }}</td>
                                    <td>{{ $value->name }}</td>
                                    <td>{{ $value->canRead ? 'Có' : 'Không' }}</td>
                                    <td>{{ $value->canWrite ? 'Có' : 'Không' }}</td>                             
                                    <td>{{ $value->canUpdate ? 'Có' : 'Không' }}</td>
                                    <td>{{ $value->canDelete ? 'Có' : 'Không' }}</td>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#permission').parent('li').addClass('active');
        $('#permission .show').addClass('active');
        $('#permission').collapse();
