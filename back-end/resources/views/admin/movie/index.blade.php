                        ...
                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $value->name }}</td>
                                    <td><img src="{{ $value->images->poster->url }}" alt="" style="width: 100px"></td>
                                    ...
                                    <td class="text-right">                                       
                                        ...
                                        <a href="{{ base_url('admin/movie/detail/'.$value->id) }}" class="btn btn-simple btn-warning btn-icon edit btn-block" style="text-align: right">Chi tiết</a>
                                        <a href="{{ base_url('admin/movie/'.$value->id.'/episode') }}" class="btn btn-simple btn-success btn-icon btn-block" style="text-align: right">Quản Lý Tập Phim</a>
                                        <a href="{{ route('Admin.CommentController._index',$value->id) }}" class="btn btn-simple btn-success btn-icon btn-block" style="text-align: right">Quản lý bình luận</a>
                                    </td>
                                </tr>
                                @endforeach
