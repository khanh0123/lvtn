                        ...
                        <div class="wizard-navigation">
                            <ul>
                                <li class="wizard-menu-top">
                                    <a href="/admin/movie/detail/{{$data->id}}#info" data-toggle="tab">Thông tin phim</a>
                                </li>
                                <li class="wizard-menu-top">
                                    <a href="/admin/movie/detail/{{$data->id}}#more" data-toggle="tab">Thể loại</a>
                                </li>
                                <li class="wizard-menu-top">
                                    <a href="/admin/movie/detail/{{$data->id}}#images" data-toggle="tab">Hình ảnh</a>
                                </li>

                                <li class="wizard-menu-top">
                                    <a href="/admin/movie/detail/{{$data->id}}#seoinfo" data-toggle="tab">Thông tin SEO</a>
                                </li>
                            </ul>
                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="form-group label-floating is-empty">
                                                        ...
                                                        <input type="text" class="form-control" name="name" value="{{ $data->name }}" required data-name="Tên phim">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="form-group label-floating is-empty">
                                                        <label class="control-label"></label>
                                                        <input type="number" class="form-control" name="epi_num" value="{{ $data->epi_num }}" required data-name="Số tập">
                                                        <span class="material-input"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-2">
                                                    <div class="form-group label-floating is-empty">
                                                        <label class="control-label"></label>
                                                        <input type="number" class="form-control" name="runtime" value="{{ $data->runtime }}" required data-name="Thời gian">
                                                        <span class="material-input"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="form-group">
                                                            <input type="date" class="form-control" value="{{ customDate($data->release_date , 'Y-m-d') }}" name="release_date">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group label-floating is-empty">
                                                    <div class="col-sm-3">
                                                        <div class="togglebutton">
                                                            <label>
                                                                <input type="checkbox" name="is_hot" value="{{ $data->is_hot ? 1 : 0 }}" {{ $data->is_hot ? 'checked' : '' }}> Phim Hot
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <div class="togglebutton">
                                                            <label>
                                                                <input type="checkbox" name="is_new" value="{{ $data->is_new ? 1 : 0 }}" {{ $data->is_new ? 'checked' : '' }}> Phim Mới
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-5">
                                                    <select data-container="body" class="selectpicker" data-live-search="true" data-size="10" data-style="btn-info" name="cat_id" required data-name="Danh mục">
                                                        ...
                                                        <option data-tokens="{{$value->name}}" value="{{$value->id}}" {{ $value->id == $data->cat_id ? 'selected' : '' }} >{{$value->name}}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-sm-5">
                                                    <select data-container="body" class="selectpicker" data-live-search="true" data-size="10" multiple data-style="btn-danger" name="genre[]" required data-name="Thể loại">
                                                        ...
                                                        <option data-tokens="{{$value->name}}" value="{{$value->id}}" {{ 
                                                            ...
                                                            'mov_id' => $data->id,
                                                            'gen_id' => $value->id
                                                            ] , $data->genre ) ? 'selected' : '' }} >{{$value->name}}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-sm-5">
                                                    <select data-container="body" class="selectpicker" data-live-search="true" data-size="10" multiple data-style="btn-secondary" name="country[]" required data-name="Quốc gia">
                                                        ...
                                                        <option data-tokens="{{$value->name}}" value="{{$value->id}}" {{ 
                                                            ...
                                                            'mov_id' => $data->id,
                                                            'cot_id' => $value->id
                                                            ] , $data->country ) ? 'selected' : '' }} > {{$value->name}} 
                                                        </option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-11 col-sm-offset-1">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="text" class="form-control" value="{{ $data->short_des }}">
                                        </div>
                                    </div>
                                    <div class="col-sm-11 col-sm-offset-1">
                                        <div class="form-group label-floating">
                                            <label class="control-label">Mô tả đầy đủ</label>
                                            <input type="text" class="form-control" value="{{ $data->long_des }}">
                                        </div>
                                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-content">                               
                                ...
                                <a class="btn btn-danger using-tooltip" href="{{ base_url('admin/movie/del/'.$data->id) }}" data-toggle="tooltip" data-placement="top" title="Xóa phim này?"><i class="material-icons">close</i>Xóa<div class="ripple-container"></div></a>
                                @endif

                                @if (session()->get('permission')->canWrite)
                                    <a href="{{ base_url("admin/movie/$data->id/episode/add") }}" class="btn btn-success using-tooltip" data-toggle="tooltip" data-placement="top" title="Thêm tập phim"><i class="material-icons">playlist_add</i>Thêm tập<div class="ripple-container"></div></a>
                                @endif
                            </div>
                        </div>
                    </div>
