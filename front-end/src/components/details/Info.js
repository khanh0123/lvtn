            ...
            <React.Fragment>
                {
                    data &&
                    <React.Fragment>
                        <CreateHelmetTag page="info" data={data} url={url} />
                                                            ...
                                                            <div className="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                                                                <div className="dec-review-dec">
                                                                    ...
                                                                    <div className="ratting">
                                                                        ...
                                                                        <a href="#" aria-label="link">{`${data.avg_rate}/5 rating`}</a>
                                                                    </div>
                                                                    <div className="dec-review-meta">
                                                                        <ul>

                                                                            <li><span>Ngày chiếu <label>:</label></span><a href="javascript:void(0)" aria-label="link">{data.release_date ? custom_date(data.release_date) : 'Đang cập nhật ..'}</a></li>
                                                                            <li>
